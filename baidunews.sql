...
--
-- Host: localhost
-- Generation Time: 2016-01-31 19:15:03
-- 服务器版本： 5.6.16
-- PHP Version: 5.5.9
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  `newstitile` varchar(30) NOT NULL,
  `newslink` text,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='百度新闻存储数据表' AUTO_INCREMENT=72 ;

--
-- 转存表中的数据 `news`
--

INSERT INTO `news` (`newsid`, `newstitile`, `newslink`, `newsimg`, `newscontent`, `newstype`, `addtime`) VALUES
